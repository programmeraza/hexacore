    ...
    >
      <body className="min-h-full flex flex-col">
        {/*
          ...
          Вынесено в отдельный файл вместо инлайн-скрипта — Next.js всё
          равно требует script-src 'unsafe-inline' для своих служебных
          скриптов гидратации, но этот конкретный код по крайней мере не
          добавляет ещё один инлайн-скрипт к странице.
        */}
